...
public class NumeroPrimitiva implements Comparable<NumeroPrimitiva> {
    ...
    public NumeroPrimitiva() {
        Random r = new Random();
        this.numero = r.nextInt(49) + 1;
    }
    
    public NumeroPrimitiva(int n) {
        this.numero = n;
    }
    ...
    public boolean equals(Object np){
        return (np instanceof NumeroPrimitiva) && (((NumeroPrimitiva) np).numero == this.numero);
    }
